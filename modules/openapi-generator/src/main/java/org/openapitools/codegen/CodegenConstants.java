...
public class CodegenConstants {
    ...
    public static final String PARCELIZE_MODEL_SET = "parcelizeModelSet";
    public static final String PARCELIZE_MODEL_SET_DESC = "add @Parcelize for specific generated models";
